      ...
      <div className="container">
        <div className="row g-5 align-items-center">
          ...
          <div className="col-lg-6" data-aos="fade-up">
            <div className="position-relative w-100 h-100" style={{ minHeight: "400px" }}>
              ...
              <div
                ...
                style={{ background: "rgba(0, 0, 0, .08)", borderRadius: "10px" }}
              >
          ...
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <h1 className="mb-2">
              <span className="text-primary">AutoPro</span> Is The Best Place For Your Auto Care
            </h1>
            <p className="mb-4">
              From routine maintenance to complex repairs, our expert team is dedicated to keeping your vehicle in top condition. We combine quality workmanship, modern diagnostics, and exceptional customer service to ensure your car gets the care it deserves.
            </p>
            ...
            <div className="row g-4 mb-3 pb-3">
              {[
                ...
                <div key={item.num} className="col-12" data-aos="fade-up" data-aos-delay={item.delay}>
