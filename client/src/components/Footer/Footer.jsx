        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-3 col-md-6">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>A.A, Ethiopia</p>
                    <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>+251-985102027</p>
                    <p className="mb-2"><i className="fa fa-envelope me-3"></i>amirmubarek01@gmail.com</p>
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <Link className="btn btn-link" to="">Vacuum Cleaning</Link>
                </div>
                <div className="col-lg-3 col-md-6">
